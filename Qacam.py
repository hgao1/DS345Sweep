...
from QDS345.DS345_Sweep import DS345
...
class Qacam(QMainWindow):
    ...
    def getDevices(self):
        ...
        try:
            ...
            logger.warning('No polargraph detected ... using fake')
            self.ui.polargraph.device = PolargraphFake()
        try:
            self.ui.lockin.device = SR830()
        except ValueError:
            logger.warning('No lockin detected ... using fake')
        ...
        try:
            ...
            logger.warning('No function generator detected ... using fake')
    ...
    def connectSignals(self):
        ...
        ui.y0.valueChanged.connect(lambda v: self.plotBelt())
    ...
    @pyqtSlot(bool)
    def sweepFinished(self,update):
        self.ui.sweep.setText('Sweep')
        self.ui.sweep.setEnabled(True)
    ...
    def scanFinished(self, update):
        ...
        y0 = self.scanner.ystart
        y1 = self.scanner.ystop
